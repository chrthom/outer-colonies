...
2. **Start the Website**:
   ...
   If the Server is not run locally, the website can also connect to the deployed staging server:
...
3. **Start the Client**:
   ...
   If the Server is not run locally, the client can also connect to the deployed staging server:
