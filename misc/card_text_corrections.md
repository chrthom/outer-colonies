...
| 236 | tags | Intervention (Taktik - Wirtschaft, Wissenschaft) | Intervention ({ICON:tactic} Wirtschaft, {ICON:tactic} Wissenschaft) | Added tactic icon placeholders for disciplines |
...
| 206 | effect | anlegen | angelegt | "anlegen" → "angelegt" (grammar fix) |
