...
@Component({
    ...
    imports: [ContentBoxComponent, InventoryItemComponent, MatCard, MatCardHeader, MatCardTitle, MatCardSubtitle, MatCardContent, MatCardActions, MatButton, OpenItemComponent]
})
